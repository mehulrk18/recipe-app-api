...
class PrivateTagAPITests(TestCase):
    ...
    def test_retrieve_tags_assigned_to_reciepes(self):
    ...
    def test_retrive_tags_unique(self):
        """Test filtering tags by assigning return unique items"""
